...
import com.xwj.word.ui.main.HomeActivity;
...
public class LoginViewModel extends BaseViewModel<Repository> {
    ...
    public SingleLiveEvent<String> agreementEvent = new SingleLiveEvent<>();
    ...
    public void onCreate() {
        super.onCreate();
        String context = "登录即视为已阅读并同意《用户协议》《隐私政策》";
        agreementEvent.setValue(context);
    }
